...
- **Nastavení:** den výplaty, kategorie (přejmenovat, vyřadit, přidat), vzhled a záloha do souboru.
- **Vzhled:** styl (Hranatý jako tištěná cenovka, nebo Kreslený jako pastelkou na čtverečkovaném papíře) a barevné schéma se volí zvlášť, takže jde libovolně kombinovat. Každé schéma má i tmavou podobu.
